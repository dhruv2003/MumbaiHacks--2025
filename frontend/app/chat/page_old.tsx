...
import { Home, TrendingUp, CreditCard, User, LogOut, MessageSquare, Wallet, BarChart3, ArrowUpRight, ArrowDownRight } from "lucide-react";

export default function ChatPage() {
    const router = useRouter();
    const [messages, setMessages] = useState<Message[]>([
        { id: "1", role: "assistant", content: "Hello! I'm your AI financial assistant. How can I help you manage your finances today?" }
    ]);
